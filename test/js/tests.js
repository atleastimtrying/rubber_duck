...
(function() {
  ...
  describe("The Brain's Pattern Matcher", function() {
    ...
    return describe("when finding nouns", function() {
      ...
      this.texts = ["I have a problem with my ducky. It just doesn't work.", "My ducky doesn't work.", "This ducky wont work", "This ducky won't play ball.", "Please help me with my ducky", "I have a ducky that keeps lying to me", "Our ducky is buggering up", "If I try to do anything funky, the ducky will balls it up", "Something has gone wrong between the ducky and the bread."];
      _ref = this.texts;
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        text = _ref[_i];
